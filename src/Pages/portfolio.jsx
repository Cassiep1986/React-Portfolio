...
function Portfolio() {
  ...
  <div className="col">
    <div className="card">
          <a href="https://adamdavidburch42.github.io/Jokester" target="_blank" rel="noopener noreferrer">
      ...
      <div className="card-body">
        ...
        <a href="https://github.com/AdamDavidBurch42/Jokester" target="_blank" rel="noopener noreferrer"><Button variant="primary">Repo Link</Button></a>
      </div>
    </div>
  </div>
  <div className="col">
